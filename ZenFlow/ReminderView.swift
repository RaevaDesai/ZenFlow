...
struct ReminderView: View {
    ...
    var exercisesSection: some View {
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            VideoSection(title: "Breathing Exercise", videoID: "inpok4MKVLM")

            VideoSection(title: "Meditation", videoID: "aNXKjGFUlMs")

            VideoSection(title: "Mindfulness Practice", videoID: "UB3tSaiEbNY")
